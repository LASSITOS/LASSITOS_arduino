...
#define SAMPLERATE_HZ 44100  // The sample rate of the audio.  ??ESP32 max 16kHz??
...
unsigned int AMPLITUDE=((1<<24)-1);   // Set the amplitude of generated waveforms.  This controls how loud
...
// //    Serial.println(sample);
    ...
    // i2s_write(I2S_PORT, &sample, BITS_SAMPLE, &i2s_bytes_write, 100);  // left right
